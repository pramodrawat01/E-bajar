...
export default function Cart() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        console.log(newAddress.phone, "this is new addrss phone number")
      } else {
  ...
  async function handleDelAddress(delId) {
    try{
      ...
      console.log(ero, "failed to delete address promise failed")
    }
  }
            ...
            <div style={{ marginBottom: "15px" }}>
              {addresses.map((addr) => (
                ...
                >
                  ...
                  <div>
                    <button onClick={()=> handleDelAddress(addr._id) }>delete</button>
                  </div>
                </div>
              ))}
            </div>
